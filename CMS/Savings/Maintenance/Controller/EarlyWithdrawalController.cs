    ...
    class EarlyWithdrawalController
    {
        ...
        public void btnEdit(object args, EventArgs e)
        {
            ...
            else
            {
                ...
                this.earlyWithdrawal.setComboDuration(durationStatus);
        ...
        public void btnSave(object args, EventArgs e)
        {
            ...
            try
            {
                ...
                if (this.earlyWithdrawal.getTextPenalty() != 0)
                {
                    if (isAdd)
                    {
                        if (this.earlyWithdrawalModel.checkPenalty(this.earlyWithdrawal.getAccountType(), this.earlyWithdrawal.getTextPenalty(), this.earlyWithdrawal.getComboPenalty(), 0) > 0)
                        {
                    ...
                    {
                        if (this.earlyWithdrawalModel.checkPenalty(this.accountType, this.earlyWithdrawal.getTextPenalty(), this.earlyWithdrawal.getComboPenalty(), this.EarlyWithdrawalId) > 0)
                        {
                            errorMessage += "Penalty Value Already Exist For This Account Type." + Environment.NewLine;
                            this.earlyWithdrawal.setErrorPenalty();
                            checkPenalty = false;
                ...
                if (this.earlyWithdrawal.getCheckMaximumBalance())
                {
                    ...
                    if (isAdd)
                    {
                        if (this.earlyWithdrawalModel.checkBalanceRange(this.earlyWithdrawal.getMinimumBalance(), this.earlyWithdrawal.getMaximumBalance(), this.earlyWithdrawal.getAccountType(), 0) > 0 || this.earlyWithdrawalModel.checkUnbracketed(this.earlyWithdrawal.getAccountType(), this.earlyWithdrawal.getMaximumBalance(), 0) > 0)
                        {
                    ...
                    {
                        if (this.earlyWithdrawalModel.checkBalanceRange(this.earlyWithdrawal.getMinimumBalance(), this.earlyWithdrawal.getMaximumBalance(), this.accountType, this.EarlyWithdrawalId) > 0 || this.earlyWithdrawalModel.checkUnbracketed(this.accountType, this.earlyWithdrawal.getMaximumBalance(), this.EarlyWithdrawalId) > 0)
                        {
                            errorMessage += "Balance Range Overlap Detected." + Environment.NewLine;
                            checkBalanceRange = false;
                        }
                ...
                else
                {
                    if (isAdd)
                    {
                        if (this.earlyWithdrawalModel.checkBracketed(this.earlyWithdrawal.getAccountType(), this.earlyWithdrawal.getMinimumBalance(), 0) > 0 || this.earlyWithdrawalModel.checkUnbracketed(this.earlyWithdrawal.getAccountType(), this.earlyWithdrawal.getMinimumBalance(), 0) > 0)
                        {
                    ...
                    {
                        if (this.earlyWithdrawalModel.checkBracketed(this.accountType, this.earlyWithdrawal.getMinimumBalance(), this.EarlyWithdrawalId) > 0 || this.earlyWithdrawalModel.checkUnbracketed(this.accountType, this.earlyWithdrawal.getMinimumBalance(), this.EarlyWithdrawalId) > 0)
                        {
                            errorMessage += "An Unbracketed Balance Already Defined As The Highest Penalty." + Environment.NewLine;
                            this.earlyWithdrawalModel.MaxRange = 0;
                            checkBalanceRange = false;
