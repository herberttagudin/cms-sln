        ...
        public void btnSave(object args, EventArgs e)
        {
            ...
            try
            {
                ...
                if (this.interestRates.getCheckMaximumBalance())
                {
                    ...
                    if (isAdd)
                    {
                        if (this.interestRatesModel.checkBalanceRange(this.interestRates.getMinimumBalance(), this.interestRates.getMaximumBalance(), this.interestRates.getAccountType(), 0) > 0 || this.interestRatesModel.checkUnbracketed(this.interestRates.getAccountType(), this.interestRates.getMaximumBalance(), 0) > 0)
                        {
                    ...
                    {
                        if (this.interestRatesModel.checkBalanceRange(this.interestRates.getMinimumBalance(), this.interestRates.getMaximumBalance(), this.accountType, this.InterestId) > 0 || this.interestRatesModel.checkUnbracketed(this.accountType, this.interestRates.getMaximumBalance(), this.InterestId) > 0)
                        {
                            errorMessage += "Balance Range Overlap Detected." + Environment.NewLine;
                            checkBalanceRange = false;
                        }
                ...
                else
                {
                    if (isAdd)
                    {
                        if (this.interestRatesModel.checkBracketed(this.interestRates.getAccountType(), this.interestRates.getMinimumBalance(), 0) > 0 || this.interestRatesModel.checkUnbracketed(this.interestRates.getAccountType(), this.interestRates.getMinimumBalance(), 0) > 0)
                        {
                            errorMessage += "An Unbracketed Balance Already Defined As The Highest Interest Rate." + Environment.NewLine;
                            this.interestRatesModel.MaxRange = 0;
                            checkBalanceRange = false;
                        }
                        else
                        {
                    ...
                    {
                        if (this.interestRatesModel.checkBracketed(this.accountType, this.interestRates.getMinimumBalance(), this.InterestId) > 0 || this.interestRatesModel.checkUnbracketed(this.accountType, this.interestRates.getMinimumBalance(), this.InterestId) > 0)
                        {
                            errorMessage += "An Unbracketed Balance Already Defined As The Highest Interest Rate." + Environment.NewLine;
                            this.interestRatesModel.MaxRange = 0;
                            checkBalanceRange = false;
