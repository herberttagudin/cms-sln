    ...
    class LoanInterestRateController
    {
        ...
        public void btnAdd(object args, EventArgs e)
        {
            ...
            if (i == 0)
            {
                ...
                MessageBox.Show("There are no more available loan types for adding interest rate.", "Add Loan Interest Rate", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        }
        ...
        public void btnSave(object args, EventArgs e)
        {
            ...
            if (isAdd)
            {
                ...
                if (countError==0)
                {
                    ...
                    if (checkExist == 1) {  
                        ...
                        DialogResult dialogResult = MessageBox.Show("Interest rate already exists. Are you sure you want to add?", "Add Interest Rate", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                ...
                {
                    MessageBox.Show("Add Failed!.\n\n" + errorMessage, "Add Loan Interest Rate", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    TypeId = 0;
                }
            }
            else
            {
                ...
                {
                    MessageBox.Show("Update Failed!.\n\n" + errorMessage, "Update Loan Interest Rate", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
