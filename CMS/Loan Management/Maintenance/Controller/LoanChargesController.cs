    ...
    class LoanChargesController
    {
                ...
                if (resu == "Yes")
                {
                    try
                    {
                        ...
                        if (loanChargeModel.deleteloanCharge(chargeId) == 1)
                        {
                            ...
                            MessageBox.Show("Delete Success.", "Delete Loan Charge", MessageBoxButtons.OK, MessageBoxIcon.Information);
                            if (this.loanCharge.checkArchivedState())
                            {
                        ...
                        {
                            MessageBox.Show("Delete Failed.", "Delete Loan Charge", MessageBoxButtons.OK, MessageBoxIcon.Error);
                        }
                        chargeId = 0;
                    }
                    catch (Exception)
                    {
                        MessageBox.Show("No rows were selected.", "Delete Loan Charge", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                }
            }
           ...
           try
            {
                ...
                catch (ArgumentException) { MessageBox.Show("No rows selected.", "Edit Loan Charge", MessageBoxButtons.OK, MessageBoxIcon.Error); loanCharge.disableFunction(); }
            }
            catch (Exception) {
                DataGridViewRow selectedData = this.loanCharge.getSelected();
        ...
        public void btnSave(object args, EventArgs e)
        {
            ...
            if (isAdd)
            {
                ...
                {
                    MessageBox.Show("Add Success.", "Add Loan Charge", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    if (this.loanCharge.checkArchivedState())
                    {
                        this.loanCharge.requirementGrid(this.loanChargeModel.selectAllLoanCharge());
                        DataGridViewRowCollection dr = this.loanCharge.getAllRows();
                ...
                {
                    MessageBox.Show("Add Failed!\n\n" + errorMessage, "Add Loan Charge", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    chargeId = 0;
                }
            }
            else
            {
                ...
                {
                    MessageBox.Show("Update Success.", "Update Loan Charge", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    if (this.loanCharge.checkArchivedState())
                    {
                        this.loanCharge.requirementGrid(this.loanChargeModel.selectAllLoanCharge());
                        DataGridViewRowCollection dr = this.loanCharge.getAllRows();
                ...
                {
                    MessageBox.Show("Update Failed!\n\n" + errorMessage, "Update Loan Charge", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
