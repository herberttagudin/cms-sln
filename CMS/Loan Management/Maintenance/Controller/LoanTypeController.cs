...
namespace CMS.Loan_Management.Maintenance.Controller
{
    class LoanAccountTypeController
    {
        ...
        public void btnEdit(object args, EventArgs e) {
            ...
            catch (Exception)
            {
               ...
               MessageBox.Show("" + selectedData.Cells[0].Value.ToString());
                MessageBox.Show("No rows were selected.", "Edit Loan Type", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        public void btnDelete(object args, EventArgs e) {
            ...
            {
                DialogResult dialogResult = MessageBox.Show("Are you sure you want to delete?", "Delete Loan Type", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                if (dialogResult == DialogResult.Yes)
                {

                    TypeId = int.Parse(selectedData.Cells["Loan Type Id"].Value.ToString());
                    if (this.loanAccountTypeModel.deleteLoanType(TypeId) == 1)
                    {
                        MessageBox.Show("Delete Success.", "Delete Loan Type", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    ...
                    {
                        MessageBox.Show("Delete Failed.", "Delete Loan Type", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        isAdd = false;
                        TypeId = 0;
                    }
                }
        ...
        public void btnSave(object args, EventArgs e) {
            ...
            if (this.loanAccountTypeModel.MinStatus == this.loanAccountTypeModel.MaxStatus)
            {
                ...
                if (isAdd)
                {
                    ...
                    {
                        MessageBox.Show("Add Failed!\n\n" + errorMessage, "Add Loan Type", MessageBoxButtons.OK, MessageBoxIcon.Error);
                        TypeId = 0;
                    }
                }
                else
                {
                    ...
                    {
                        MessageBox.Show("Update Failed!\n\n" + errorMessage, "Update Loan Type", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
        ...
        public void btnRetrieve(object args, EventArgs e)
        {
            ...
            if (checkExist == 1)
            {
                MessageBox.Show("Name of archived loan type already exists.\nPlease edit loan type name, save and retrieve again.", "Retrieve Loan Penalty", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
            else
            {
