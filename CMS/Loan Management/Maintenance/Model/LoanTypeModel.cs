...
namespace CMS.Loan_Management.Maintenance.Model
{
    class LoanTypeModel
    {
       ...
       /* public DataSet selectFixedCollateral(int LoanTypeId)
        ...
        {
            DAL dal = new DAL(ConfigurationManager.ConnectionStrings["CMS"].ConnectionString);
            String sql = "UPDATE LOAN_TYPE SET isArchived = 1 WHERE LoanTypeId = @TypeId";
            Dictionary<String, Object> parameters = new Dictionary<string, object>();
        ...
        public int insertLoanType(ArrayList memberTypeNo, int Collateral, int Status)
        {
            ...
            String sqlSelect = "Select LoanTypeId from LOAN_TYPE where isArchived=0 and LoanTypeName= " + "'" + Name + "'";
