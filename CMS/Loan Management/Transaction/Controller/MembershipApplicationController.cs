...
namespace CMS.Loan_Management.Transaction.Controller
{
    class MembershipApplicationController
    {
        ...
        public void setCheckedRequirements(String accountNo) {

            DataTable dt = this.memberModel.selectActiveRequirements(accountNo).Tables[0];
            ArrayList activeRequirements = new ArrayList();
            ...
            foreach (DataRow dr in dt.Rows) {
                ...
                foreach (KeyValuePair<int, string> pair in requirements)
                {
                    if (int.Parse(dr[0].ToString()) == pair.Key)
                        activeRequirements.Add(pair.Value);
                }
        ...
        {
            this.membershipApplication.page4Prev();
        }
        ...
        public bool checkPage1() {
            ...
            if (this.memberModel.AddressZip == String.Empty) {
                result = false;
                this.membershipApplication.errorZip();
            }
        ...
        public bool checkPage2() {
            ...
            this.memberModel.Gross = double.Parse(this.membershipApplication.getGross() + 0);
        ...
        public void btnSave(object args, EventArgs e)
        {
            ...
            if (checkPage1() & checkPage2() & checkPage3() & result)
            {
        ...
        public void btnUpdate(object args, EventArgs e) {
            ...
            if (this.memberModel.acctHolderSign1 == null && this.memberModel.acctHolderSign2 == null && this.memberModel.acctHolderSign3 == null)
            {
                result = false;
                this.membershipApplication.errorAcctSign();
            }

            if (this.membershipApplication.checkMinor() && this.memberModel.guardianSign1 == null && this.memberModel.guardianSign2 == null && this.memberModel.guardianSign3 == null)
            {
                result = false;
                this.membershipApplication.errorGuardianSign();
            }
