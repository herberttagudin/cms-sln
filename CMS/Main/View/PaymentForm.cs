...
namespace CMS.Main.View
{
    public partial class PaymentForm : UserControl
    {
        ...
        private void cbLoanType_SelectedIndexChanged(object sender, EventArgs e)
        {
            this.txtAmountDue.Text = "0.00";
            ...
            this.chbPayAll.Checked = false;
                        ...
                        if (i == -1) { this.dataAmortization.DataSource = null; }
                        else
                        {
                            int row = this.dataLoan.SelectedRows[0].Index;
                            this.classGridAmortization(this.paymentModel.selectAmortizations(this.dataLoan[0, row].Value.ToString(), this.getTypeOfLoan()));
